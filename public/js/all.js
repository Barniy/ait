! function () {
    if ("ontouchstart" in window) {
        ...
        e = function (e, t) {
            ...
            return s.time = t, s.x = r, s.y = i, (!e.simulated && (500 > n || 1500 > n && a[0] < 50 && a[1] < 50) || d) && (e.preventDefault(), e.stopPropagation(), !d) ? !1 : (d && (window.location = c.getAttribute("href")), void(c && c.classList && (c.classList.add("energize-focus"), window.setTimeout(function () {
    ...
    function o(e) {
        var t = he[e] = {};
        return G.each(e.match(pe) || [], function (e, n) {
            t[n] = !0
        }), t
    }
    ...
    function b(t, n) {
        var r, i = G(n.createElement(t)).appendTo(n.body),
    ...
    function M(e, t, n) {
        var r, i, o, s, a, c, l, u, d = this,
            ...
            h = e.nodeType && ke(e),
            g = ve.get(e, "fxshow");
        n.queue || (a = G._queueHooks(e, "fx"), null == a.unqueued && (a.unqueued = 0, c = a.empty.fire, a.empty.fire = function () {
            a.unqueued || c()
        }), a.unqueued++, d.always(function () {
            d.always(function () {
                a.unqueued--, G.queue(e, "fx").length || a.empty.fire()
            })
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], l = G.css(e, "display"), u = "none" === l ? ve.get(e, "olddisplay") || w(e.nodeName) : l, "inline" === u && "none" === G.css(e, "float") && (p.display = "inline-block")), n.overflow && (p.overflow = "hidden", d.always(function () {
        ...
        if (G.isEmptyObject(f)) "inline" === ("none" === l ? w(e.nodeName) : l) && (p.display = l);
            ...
            g ? "hidden" in g && (h = g.hidden) : g = ve.access(e, "fxshow", {}), o && (g.hidden = !h), h ? G(e).show() : d.done(function () {
                G(e).hide()
            }), d.done(function () {
                var t;
                ve.remove(e, "fxshow");
    ...
    function $(e, t, n) {
        ...
        return G.map(u, j, l), G.isFunction(l.opts.start) && l.opts.start.call(e, l), G.fx.timer(G.extend(c, {
            elem: e,
            anim: l,
            queue: l.opts.queue
    ...
    G.fn = G.prototype = {
        ...
        var e, t, n, r, i, o, s = arguments[0] || {},
            ...
            c = arguments.length,
            l = !1;
        for ("boolean" == typeof s && (l = s, s = arguments[a] || {}, a++), "object" == typeof s || G.isFunction(s) || (s = {}), a === c && (s = this, a--); c > a; a++)
            if (null != (e = arguments[a]))
                for (t in e) n = s[t], r = e[t], s !== r && (l && r && (G.isPlainObject(r) || (i = G.isArray(r))) ? (i ? (i = !1, o = n && G.isArray(n) ? n : []) : o = n && G.isPlainObject(n) ? n : {}, s[t] = G.extend(l, o, r)) : void 0 !== r && (s[t] = r));
        return s
    }, G.extend({
        ...
        map: function (e, t, r) {
            var i, o = 0,
                ...
                c = [];
            if (a)
                for (; s > o; o++) i = t(e[o], o, r), null != i && c.push(i);
            else
        ...
        proxy: function (e, t) {
            var n, r, i;
            return "string" == typeof t && (n = e[t], t = e, e = n), G.isFunction(e) ? (r = z.call(arguments, 2), i = function () {
                return e.apply(t || this, r.concat(z.call(arguments)))
            }, i.guid = e.guid = e.guid || G.guid++, i) : void 0
        },
        now: Date.now,
        support: Z
    ...
    var ie = function (e) {
        ...
        function v(e, t, n, i, o, s) {
            return i && !i[I] && (i = v(i)), o && !o[I] && (o = v(o, s)), r(function (r, s, a, c) {
                var l, u, d, f = [],
                    p = [],
                    h = s.length,
                    ...
                    b = n ? o || (r ? e : h || i) ? [] : s : y;
                if (n && n(y, b, a, c), i)
                    for (l = m(b, p), i(l, [], a, c), u = l.length; u--;)(d = l[u]) && (b[p[u]] = !(y[p[u]] = d));
                if (r) {
                    if (o || e) {
                        if (o) {
        ...
        function y(e) {
            for (var t, n, r, i = e.length, o = _.relative[e[0].type], s = o || _.relative[" "], a = o ? 1 : 0, c = p(function (e) {
                    return e === t
                }, s, !0), l = p(function (e) {
                    return ee(t, e) > -1
                ...
                if (n = _.relative[e[a].type]) u = [p(h(u), n)];
                    ...
                    if (n = _.filter[e[a].type].apply(null, e[a].matches), n[I]) {
                        ...
                        return v(a > 1 && h(u), a > 1 && f(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(ce, "$1"), n, r > a && y(e.slice(a, r)), i > r && y(e = e.slice(r)), i > r && f(e))
                    }
                    u.push(n)
                } return h(u)
        }
        ...
        var w, x, _, k, C, N, E, S, T, A, L, j, M, q, $, O, R, D, B, I = "sizzle" + 1 * new Date,
            H = e.document,
            F = 0,
            P = 0,
            z = n(),
        ...
        x = t.support = {}, C = t.isXML = function (e) {
            ...
            return r !== M && 9 === r.nodeType && r.documentElement ? (M = r, q = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", ke, !1) : n.attachEvent && n.attachEvent("onunload", ke)), $ = !C(r), x.attributes = i(function (e) {
            ...
            }, R = [], O = [], (x.qsa = ve.test(r.querySelectorAll)) && (i(function (e) {
            ...
            })), (x.matchesSelector = ve.test(D = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector)) && i(function (e) {
                x.disconnectedMatch = D.call(e, "div"), D.call(e, "[s!='']:x"), R.push("!=", se)
            }), O = O.length && new RegExp(O.join("|")), R = R.length && new RegExp(R.join("|")), t = ve.test(q.compareDocumentPosition), B = t || ve.test(q.contains) ? function (e, t) {
            ...
            if ((e.ownerDocument || e) !== M && j(e), n = n.replace(de, "='$1']"), !(!x.matchesSelector || !$ || R && R.test(n) || O && O.test(n))) try {
                var r = D.call(e, n);
            ...
            filter: {
                ...
                CHILD: function (e, t, n, r, i) {
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        var l, u, d, f, p, h, g = o !== s ? "nextSibling" : "previousSibling",
                            m = t.parentNode,
                        ...
                        if (m) {
                            ...
                            if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                ...
                                for (;
                                    (d = ++p && d && d[g] || (f = p = 0) || h.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[I] || (d[I] = {}))[e] = [F, f]), d !== t)););
        ...
        return d.prototype = _.filters = _.pseudos, _.setFilters = new d, N = t.tokenize = function (e, n) {
            ...
            for (a = e, c = [], l = _.preFilter; a;) {
                (!r || (i = le.exec(a))) && (i && (a = a.slice(i[0].length) || a), c.push(o = [])), r = !1, (i = ue.exec(a)) && (r = i.shift(), o.push({
                    value: r,
                    type: i[0].replace(ce, " ")
                }), a = a.slice(r.length));
                for (s in _.filter) !(i = he[s].exec(a)) || l[s] && !(i = l[s](i)) || (r = i.shift(), o.push({
                    value: r,
                    type: s,
                    matches: i
                }), a = a.slice(r.length));
        ...
        }, x.sortStable = I.split("").sort(Q).join("") === I, x.detectDuplicates = !!L, j(), x.sortDetached = i(function (e) {
    ...
    var ce, le = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
        ue = G.fn.init = function (e, t) {
            ...
            if ("string" == typeof e) {
                ...
                if (n[1]) {
                    if (t = t instanceof G ? t[0] : t, G.merge(this, G.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : Y, !0)), se.test(n[1]) && G.isPlainObject(t))
    ...
    G.Callbacks = function (e) {
            ...
            d = {
                add: function () {
                    if (c) {
                        ...
                        }(arguments), r ? s = c.length : t && (i = n, u(t))
                    }
                    return this
                },
                remove: function () {
                    return c && G.each(arguments, function (e, t) {
                        for (var n;
                            (n = G.inArray(t, c, n)) > -1;) c.splice(n, 1), r && (s >= n && s--, a >= n && a--)
                    }), this
                },
                has: function (e) {
        ...
        when: function (e) {
            ...
            if (s > 1)
                for (t = new Array(s), n = new Array(s), r = new Array(s); s > i; i++) o[i] && G.isFunction(o[i].promise) ? o[i].promise().done(l(i, r, o)).fail(c.reject).progress(l(i, n, t)) : --a;
    ...
    G.event = {
        ...
        add: function (e, t, n, r, i) {
            var o, s, a, c, l, u, d, f, p, h, g, m = ve.get(e);
            if (m)
                for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = G.guid++), (c = m.events) || (c = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
                        return typeof G !== Ne && G.event.triggered !== t.type ? G.event.dispatch.apply(e, arguments) : void 0
                    }), t = (t || "").match(pe) || [""], l = t.length; l--;) a = Ae.exec(t[l]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p && (d = G.event.special[p] || {}, p = (i ? d.delegateType : d.bindType) || p, d = G.event.special[p] || {}, u = G.extend({
                    type: p,
                    origType: g,
                    data: r,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, o), (f = c[p]) || (f = c[p] = [], f.delegateCount = 0, d.setup && d.setup.call(e, r, h, s) !== !1 || e.addEventListener && e.addEventListener(p, s, !1)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), i ? f.splice(f.delegateCount++, 0, u) : f.push(u), G.event.global[p] = !0)
        },
        remove: function (e, t, n, r, i) {
            var o, s, a, c, l, u, d, f, p, h, g, m = ve.hasData(e) && ve.get(e);
            if (m && (c = m.events)) {
        ...
        trigger: function (t, n, r, i) {
            ...
            if (s = a = r = r || Y, 3 !== r.nodeType && 8 !== r.nodeType && !Te.test(p + G.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), l = p.indexOf(":") < 0 && "on" + p, t = t[G.expando] ? t : new G.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : G.makeArray(n, [t]), d = G.event.special[p] || {}, i || !d.trigger || d.trigger.apply(r, n) !== !1)) {
                ...
                for (o = 0;
                    (s = f[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? c : d.bindType || p, u = (ve.get(s, "events") || {})[t.type] && ve.get(s, "handle"), u && u.apply(s, n), u = l && s[l], u && u.apply && G.acceptData(s) && (t.result = u.apply(s, n), t.result === !1 && t.preventDefault());
            ...
            if (a[0] = e, e.delegateTarget = this, !l.preDispatch || l.preDispatch.call(this, e) !== !1) {
                for (s = G.event.handlers.call(this, e, c), t = 0;
                    ...
                    for (e.currentTarget = i.elem, n = 0;
                        (o = i.handlers[n++]) && !e.isImmediatePropagationStopped();)(!e.namespace_re || e.namespace_re.test(o.namespace)) && (e.handleObj = o, e.data = o.data, r = ((G.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, a), void 0 !== r && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation()));
    ...
    Be.optgroup = Be.option, Be.tbody = Be.tfoot = Be.colgroup = Be.caption = Be.thead, Be.th = Be.td, G.extend({
        clone: function (e, t, n) {
            var r, i, o, s, a = e.cloneNode(!0),
                c = G.contains(e.ownerDocument, e);
            if (!(Z.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || G.isXMLDoc(e)))
        ...
        buildFragment: function (e, t, n, r) {
            ...
            for (u.textContent = "", f = 0; i = d[f++];)
                if ((!r || -1 === G.inArray(i, r)) && (c = G.contains(i.ownerDocument, i), o = v(u.appendChild(i), "script"), c && g(o), n))
        ...
        cleanData: function (e) {
            for (var t, n, r, i, o = G.event.special, s = 0; void 0 !== (n = e[s]); s++) {
                if (G.acceptData(n) && (i = n[ve.expando], i && (t = ve.cache[i]))) {
                    if (t.events)
                        for (r in t.events) o[r] ? G.event.remove(n, r) : G.removeEvent(n, r, t.handle);
        ...
        domManip: function (e, t) {
            ...
            var n, r, i, o, s, a, c = 0,
                ...
                f = e[0],
                g = G.isFunction(f);
            if (g || l > 1 && "string" == typeof f && !Z.checkClone && $e.test(f)) return this.each(function (n) {
                var r = u.eq(n);
            ...
            if (l && (n = G.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                ...
                if (o)
                    for (a = i[i.length - 1].ownerDocument, G.map(i, h), c = 0; o > c; c++) s = i[c], Oe.test(s.type || "") && !ve.access(s, "globalEval") && G.contains(a, s) && (s.src ? G._evalUrl && G._evalUrl(s.src) : G.globalEval(s.textContent.replace(De, "")))
            }
            return this
        }
    }), G.each({
    ...
    ! function () {
        ...
        s.style && (s.style.backgroundClip = "content-box", s.cloneNode(!0).style.backgroundClip = "", Z.clearCloneStyle = "content-box" === s.style.backgroundClip, o.style.cssText = "border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute", o.appendChild(s), e.getComputedStyle && G.extend(Z, {
    ...
    G.extend({
        ...
        G.cssHooks[t] = {
            get: function (e, n, r) {
                return n ? We.test(G.css(e, "display")) && 0 === e.offsetWidth ? G.swap(e, Ve, function () {
                    return E(e, t, r)
                }) : E(e, t, r) : void 0
            },
            set: function (e, n, r) {
    ...
    var Ze, Ye, Je = /^(?:toggle|show|hide)$/,
        ...
        nt = {
            "*": [function (e, t) {
                ...
                if (s && s[3] !== o) {
                    o = o || s[3], i = i || [], s = +r || 1;
                    do a = a || ".5", s /= a, G.style(n.elem, e, s + o); while (a !== (a = n.cur() / r) && 1 !== a && --c)
                }
    ...
    var rt, it, ot = G.expr.attrHandle;
    G.fn.extend({
        attr: function (e, t) {
    ...
    G.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(G.isFunction(e) ? function (n) {
                ...
                if ("string" === n)
                    for (var t, r = 0, i = G(this), o = e.match(pe) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
    ...
    G.fn.extend({
        val: function (e) {
            ...
            return arguments.length ? (r = G.isFunction(e), this.each(function (n) {
                var i;
                1 === this.nodeType && (i = r ? e.call(this, n, G(this).val()) : e, null == i ? i = "" : "number" == typeof i ? i += "" : G.isArray(i) && (i = G.map(i, function (e) {
                    return null == e ? "" : e + ""
                })), t = G.valHooks[this.type] || G.valHooks[this.nodeName.toLowerCase()], t && "set" in t && void 0 !== t.set(this, i, "value") || (this.value = i))
            })) : i ? (t = G.valHooks[i.type] || G.valHooks[i.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(i, "value")) ? n : (n = i.value, "string" == typeof n ? n.replace(ct, "") : null == n ? "" : n)) : void 0
        }
    }), G.extend({
        valHooks: {
            option: {
    ...
    G.extend({
        ...
        ajax: function (e, t) {
            ...
            var r, i, o, s, a, c, l, u, d = G.ajaxSetup({}, t),
                f = d.context || d,
            ...
            if (h.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, d.url = ((e || d.url || xt) + "").replace(dt, "").replace(mt, _t[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = G.trim(d.dataType || "*").toLowerCase().match(pe) || [""], null == d.crossDomain && (c = vt.exec(d.url.toLowerCase()), d.crossDomain = !(!c || c[1] === _t[1] && c[2] === _t[2] && (c[3] || ("http:" === c[1] ? "80" : "443")) === (_t[3] || ("http:" === _t[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = G.param(d.data, d.traditional)), R(yt, d, t, x), 2 === b) return x;
    ...
    }), Z.cors = !!jt && "withCredentials" in jt, Z.ajax = jt = !!jt, G.ajaxTransport(function (e) {
        var t;
    ...
    G.ajaxSetup({
        ...
        return a || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = G.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(qt, "$1" + i) : t.jsonp !== !1 && (t.url += (ut.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
    ...
    G.fn.load = function (e, t, n) {
        ...
        var r, i, o, s = this,
            a = e.indexOf(" ");
        return a >= 0 && (r = G.trim(e.slice(a)), e = e.slice(0, a)), G.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), s.length > 0 && G.ajax({
            url: e,
            type: i,
            dataType: "html",
            data: t
    ...
    G.offset = {
        setOffset: function (e, t, n) {
            var r, i, o, s, a, c, l, u = G.css(e, "position"),
                d = G(e),
                f = {};
        ...
        offset: function (e) {
            ...
            var t, n, r = this[0],
                ...
                o = r && r.ownerDocument;
            return o ? (t = o.documentElement, G.contains(t, r) ? (typeof r.getBoundingClientRect !== Ne && (i = r.getBoundingClientRect()), n = F(o), {
...
function () {
    ...
    function (e, t) {
        ...
        function u(e, n, i, o) {
            ...
            function v(e, n) {
                var r = e.cN ? p(e.cN, "", !0) : "";
                e.rB ? (E += r, S = "") : e.eB ? (E += t(n) + r, S = "") : (E += r, S = n), C = Object.create(e, {
                    parent: {
                        value: C
                    }
                })
            ...
            function y(e, n) {
                ...
                if (i) {
                    var o = C;
                    o.rE || o.eE || (S += n), E += m();
                    do C.cN && (E += "</span>"), T += C.r, C = C.parent; while (C != i.parent);
        ...
        function h(e) {
            ...
            if (!i(t)) {
                ...
                s.value = f(s.value), e.innerHTML = s.value, e.className = p(e.className, t, s.language), e.result = {
                    language: s.language,
                    re: s.r
        ...
        highlight: function (e, t, n, r) {
            if (3 === e.nodeType) {
                ...
                for (var c = 0; c < e.childNodes.length; c++) c += jQuery.highlight(e.childNodes[c], t, n, r);
            return 0
        }
    ...
    function (e) {
        ...
        e.cleanData = function (t) {
            ...
            return t = t.split(".")[1], i = l + "-" + t, r || (r = n, n = e.Widget), e.expr[":"][i.toLowerCase()] = function (t) {
                ...
                return e.isFunction(r) ? void(c[t] = function () {
                    var e = function () {
            ...
            for (var r, i, o = n.call(arguments, 1), s = 0, a = o.length; a > s; s++)
                for (r in o[s]) i = o[s][r], o[s].hasOwnProperty(r) && void 0 !== i && (e.isPlainObject(i) ? t[r] = e.isPlainObject(t[r]) ? e.widget.extend({}, t[r], i) : e.widget.extend({}, i) : t[r] = i);
            return t
            ...
            e.Widget.prototype["_" + t] = function (r, i, o) {
                ...
                i = i || {}, "number" == typeof i && (i = {
                    duration: i
                }), s = !e.isEmptyObject(i), i.complete = o, i.delay && r.delay(i.delay), s && e.effects && e.effects.effect[a] ? r[t](i) : a !== t && r[a] ? r[a](i.duration, i.easing, o) : r.queue(function (n) {
    ...
    function (e) {
        ...
        e.widget("toc.tocify", {
            ...
            _generateToc: function () {
                ...
                return t = -1 !== this.options.selectors.indexOf(",") ? e(this.options.context).find(this.options.selectors.replace(/ /g, "").substr(0, this.options.selectors.indexOf(","))) : e(this.options.context).find(this.options.selectors.replace(/ /g, "")), t.length ? (r.element.addClass(i), void t.each(function (t) {
                    e(this).is(o) || (n = e("<ul/>", {
                        id: c + t,
                        "class": c
                    }).append(r._nestElements(e(this), t)), r.element.append(n), e(this).nextUntil(this.nodeName.toLowerCase()).each(function () {
                        0 === e(this).find(r.options.selectors).length ? e(this).filter(r.options.selectors).each(function () {
                            e(this).is(o) || r._appendSubheaders.call(this, r, n)
                        }) : e(this).find(r.options.selectors).each(function () {
                            e(this).is(o) || r._appendSubheaders.call(this, r, n)
                        })
                    }))
            ...
            _nestElements: function (t, n) {
                var r, i, o;
                return r = e.grep(this.items, function (e) {
                    return e === t.text()
                }), r.length ? this.items.push(t.text() + n) : this.items.push(t.text()), o = this._generateHashValue(r, t, n), i = e("<li/>", {
                    "class": f,
                    "data-unique": o
                }).append(e("<a/>", {
                    text: t.text()
            ...
            _appendSubheaders: function (t, n) {
                ...
                s > o ? t.element.find(d + "[data-tag=" + o + "]").last().append(t._nestElements(e(this), r)) : o === s ? n.find(p).last().after(t._nestElements(e(this), r)) : n.find(p).last().after(e("<ul/>", {
                    "class": u,
                    "data-tag": o
                })).next(d).append(t._nestElements(e(this), r))
            },
                ...
                this.element.on("click.tocify", "li", function (n) {
                    ...
                    e("html, body").promise().done(function () {
                        ...
                        if (i.options.extendPage && (i.webkit && l >= f - u - i.options.extendPageOffset || !i.webkit && u + l > d - i.options.extendPageOffset) && !e(g).length) {
                            ...
                            a = s.offset().top, e(i.options.context).append(e("<div />", {
                                "class": h,
                        ...
                        setTimeout(function () {
                            ...
                            var c = e(t).scrollTop();
                            if (i.cachedAnchors.each(function (e) {
                                    return i.cachedHeights[e] - c < 0 ? void(a = e) : !1
                                }), s = e(i.cachedAnchors[a]).attr("data-unique"), o = e('li[data-unique="' + s + '"]'), i.options.highlightOnScroll && o.length && !o.hasClass(i.focusClass)) {
            ...
            show: function (t, n) {
                var r = this;
                if (!t.is(":visible")) switch (t.find(d).length || t.parent().is(l) || t.parent().is(":visible") ? t.children(d).length || t.parent().is(l) || (t = t.closest(d)) : t = t.parents(d).add(t), r.options.showEffect) {
                    case "none":
                        t.show();
                        break;
                    case "show":
            ...
            _scrollTo: function (t) {
                ...
                return e("html, body").promise().done(function () {
                    e("html, body").animate({
                        scrollTop: e('div[data-unique="' + t.attr("data-unique") + '"]').next().offset().top - (e.isFunction(i) ? i.call() : i) + "px"
                    }, {
                        duration: r
                    })
                }), n
                ...
                n.forEach(function (t, n, s) {
                    var a = 1 / s.length * this._fields.length * o,
                        ...
                        l = this.tokenStore.expand(t).reduce(function (n, i) {
                            ...
                            return o > -1 && r.insert(o, a * s * l), Object.keys(c.tokenStore.get(i)).forEach(function (e) {
                                u.add(e)
                            }), n.union(u)
                        }, new e.SortedSet);
                    i.push(l)
    ...
    function (e) {
        ...
        function t(t) {
            if (t && "" !== t) {
                ...
                for (var n = 0; n < u.length; n++) $("code.language-" + u[n]).parent().hide();
                $("code.language-" + t).parent().show(), e.toc.calculateHeights(), $(window.location.hash).get(0) && $(window.location.hash).get(0).scrollIntoView(!0)
            }
        }
        ...
        var d = function () {
            ...
            f = function () {
                ...
                }), $(".page-wrapper").click(d), $(".tocify-item").click(d)
            };
        $(function () {
            f(), l(), $(".content").imagesLoaded(function () {
    ...
    function () {
        ...
        function n(e) {
            if (i(), s.addClass("visible"), 27 === e.keyCode && (this.value = ""), this.value) {
                ...
                }), r.call(this)) : (s.html("<li></li>"), $(".search-results li").text('No Results Found for "' + this.value + '"'))
        ...
        var o, s, a = {
            ...
            c = new lunr.Index;
        c.ref("id"), c.field("title", {
            boost: 10
        }), c.field("body"), c.pipeline.add(lunr.trimmer, lunr.stopWordFilter), $(e), $(t)
    }();